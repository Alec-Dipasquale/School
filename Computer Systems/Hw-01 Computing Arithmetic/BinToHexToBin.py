...
def hexToBin(hexadecimalNumber):
    ...
    for i in range(len(hexList)):
        digit = int(__switchHexToDec(hexList[i]))
...
binaryNum = 10110101
hexa = binToHex(binaryNum)
backTo = hexToBin(hexa)
print("\n\nNumber: " + str(binaryNum))
print("Result toHex: " + str(hexa))
print("Result back: " + str(backTo) + "\n\n")